            ...
            foreach ($posts as  $value) {
                ...
                if($author){
                    ...
                    if(isset($value['yoast_head_json']["schema"]['@graph'][0]['thumbnailUrl'])){
                        ...
                        $image_cover_url = str_replace('https://togoactualite.com/wp-content/uploads', 'https://togoactualite.com/storage/uploads', $value['yoast_head_json']["schema"]['@graph'][0]['thumbnailUrl']);

                        $link_file = str_replace('https://togoactualite.com/wp-content/uploads', 'https://togoactualite.com/storage/uploads', $value['yoast_head_json']["schema"]['@graph'][0]['thumbnailUrl']);
                    ...
                    if(isset($value['yoast_head_json']["schema"]['@graph'][0]['thumbnailUrl'])){
                        ...
                        $info =  File::where('file_url',  str_replace('https://togoactualite.com/wp-content/uploads', 'https://togoactualite.com/storage/uploads', $value['yoast_head_json']["schema"]['@graph'][0]['thumbnailUrl']))->first();
