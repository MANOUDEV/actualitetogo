    ...
    public function run()
    {
        $datas = [
            [
                ...
                'authorName' => 'MawuwonamTg',
                'slug' => 'mawuwonamtg',
                'wp_author_id' => 1,
                'date_publish' =>  now(),
                'description' => "<p>
                    Nous tenons à rappeler aux visiteurs du site que
                    sans partenariat avec togoactu.com, la reprise des articles même partielle est strictement interdite.
        ...
        foreach ($datas as $data){
            ...
            if (Storage::disk('public')->exists('sitemap_authors.xml')) {
                ...
                $newContent = '
    <url>    
        <loc>https://togoactu.com/authors/'.$data['slug'].'</loc>
