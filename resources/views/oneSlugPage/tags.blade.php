                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="bg-primary bg-opacity-10 p-4 p-md-5 rounded-3 text-center">
                                <h1 class="text-primary">#{{ $tag->name }}</h1>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-9 text-center mx-auto my-0 my-md-5 py-0 py-lg-5 position-relative z-index-9">
                                        ...
                                        <p>Aucun article n'a été publié pour le tag {{ $tag->name }}</p>
                                ...
                                <div data-sticky data-margin-top="80" data-sticky-for="767">
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="text-center mt-3">
                                            <a href="/search-article" class="fw-bold text-body text-primary-hover"><u>Rechercher une publication</u></a>
                                        </div>
