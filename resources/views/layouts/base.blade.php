...
<html lang="en">
    ...
    <body>
        ...
        <div id="bloc" class="alert alert-dismissible fade show bg-dark text-white position-fixed start-0 bottom-0 z-index-99 shadow p-4 ms-3 mb-3 col-9 col-md-4 col-lg-4 col-xl-3" role="alert">
            Ce site Web garde des informations sur votre ordinateur. Pour en savoir plus sur ces informations que nous utilisons, consultez notre <a class="text-white" href="/confidentialite"> Politique de confidentialité</a>
            <div class="mt-4">
