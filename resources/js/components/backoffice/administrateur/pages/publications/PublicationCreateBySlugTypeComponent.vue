        ...
        <div class="container">
            ...
            <div v-else-if="dataReady== 1">
                <div v-if="empty == 0">
                    ...
                    <div class="row g-4 pb-4" v-if="publicationCreateBySlugTypeShowData">
                        <div class="col-12">
                    ...
                    <div class="row g-4" v-if="publicationCreateBySlugTypeShowData.typePublication.id === 2 || publicationCreateBySlugTypeShowData.typePublication.id === 3 "> 
                        <CreateAlertInfosAnnonceComponent :publicationCreate="publicationCreateBySlugTypeShowData" />
                    </div> 

                    <div class="row g-4" v-else-if="publicationCreateBySlugTypeShowData.typePublication.id === 5" >
                        <CreatePublicitesComponent :publicationCreate="publicationCreateBySlugTypeShowData" />
                    </div>
                    <div class="row g-4" v-else-if="publicationCreateBySlugTypeShowData.typePublication.id === 1" >
                        <CreateArticleComponent :publicationCreate="publicationCreateBySlugTypeShowData" />
                    </div>
...
import CreateAlertInfosAnnonceComponent from './create/CreateAlertInfosAnnonceComponent.vue';
import manageFilesPubStore from './create/manageFiles/nanagePublicitesFiles.vue';  
import CreatePublicitesComponent from './create/CreatePublicitesComponent.vue';  
import CreateArticleComponent from './create/CreateArticleComponent.vue'; 
export default {
    components: {
        CreateAlertInfosAnnonceComponent, CreatePublicitesComponent, CreateArticleComponent ,manageFilesPubStore  
    },
    data () {
        return {
            dataReady: 0,
