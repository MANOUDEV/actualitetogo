    ...
    <div class="col-lg-12 col-xxl-8">
        ...
        <div class="card border mb-4">
            <div class="card-header border-bottom p-3">
                <div class="d-sm-flex justify-content-sm-between align-items-center " v-if="stepStorePublicitesFirst == true">
                ...
                <div class="d-sm-flex justify-content-sm-between align-items-center " v-else-if="stepStorePublicitesTwo == true">
                    <div class="d-flex align-items-center">
                ...
                <div class="d-sm-flex justify-content-sm-between align-items-center" v-else-if="stepStorePublicitesThree == true">
                    <div class="d-flex align-items-center">
...
export default {
    ...
    computed: {
        ...
        ...mapGetters('storePublicitesFirstAdmin',{ 
        ...
        ...mapGetters('storePublicitesThreeAdmin',{ 
    ...
    methods:{
        ...
        ...mapActions("storePublicitesFirstAdmin",{ 
        ...
        ...mapActions("storePublicitesThreeAdmin",{ 
