<template>
    ...
    <span v-else-if="dataReady == 2">
        ...
        <span class="nav-link text-dark" v-else-if="loadingConnect" style="cursor: pointer">Connexion en cours ...</span>
    </span>

    <span v-else-if="dataReady == 3 ">
        <span class="nav-link text-dark" v-if="!loadingConnect"  @click="loginClick" style="cursor: pointer">Se connecter</span>
        <span class="nav-link text-dark" v-else-if="loadingConnect" >Connexion en cours ...</span>
    </span>
