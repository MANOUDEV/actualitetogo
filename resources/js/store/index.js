...
import  storeAnnonceAlertInfosAdminModule from './modules/backoffice/admin/publications/create/storeAnnonceAlertInfos'

import  storePublicitesAdminModule from './modules/backoffice/admin/publications/create/storePublicites'

import  storeArticleAdminModule from './modules/backoffice/admin/publications/create/storeArticle'
...
const store = createStore({
    modules:{
        ...
        storeAnnonceAlertInfosAdmin: storeAnnonceAlertInfosAdminModule,
        storePublicitesAdmin: storePublicitesAdminModule,
        storeArticleAdmin: storeArticleAdminModule,
